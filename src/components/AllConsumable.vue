        ...
        <div v-if="this.activeUpload==true">
         <v-dialog
          ...
          v-model="activeUpload" >
           ...
           <v-card>
             <v-card-title style="background-color:#ccc;color:black">Upload Consumable Types</v-card-title>
        ...
        methods: {
           ...
           uploadFile(event){
            ...
            submitFIle(){
                if(this.file ==''){
                   ...
                   formData.append('consumables',this.file)
                   this.isUploadCard=true;
                         this.uploadConsumables(formData).then((response) => {
                  ...
                  activeUploadCard(){
                    ...
                    confirmToDelete(){
                     ...
                     var reqJSON= this.delItem
                       this.deleteConsumables(reqJSON).then((response) => {
                    if(response.status==200){
                         this.text=response.data.message;
                         this.snackbar=true
                         this.activeColor='';
          ...
          this.addItem(reqJSON).then(response => {
            ...
            setInterval(this.close(), 3000);
                  ...
                  //GET API Calls
               getConsumables(){
                     this.getAllConsumablesList().then((response) => {
