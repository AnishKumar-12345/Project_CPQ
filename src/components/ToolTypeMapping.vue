    ...
    <div v-if="this.activeUpload==true">
         <v-dialog
          ...
          v-model="activeUpload" >
           ...
           <v-card>
             <v-card-title style="background-color:#2cb1fe;color:white;">Upload Tool Type Mapping</v-card-title>
        ...
        methods: {
           ...
           uploadItem(event){
            ...
            submitFile(){
                   ...
                   formData.append('tool-type-accessories-type-map',this.file)
                   this.isProgress=true;
                this.Uploadaccessorirestypemap(formData).then((response) => {
          ...
          this.addItem(reqJSON).then(response => {
            ...
            setInterval(this.close(), 3000);
               ...
               getItems(){
                    ...
                    this.getAlltoolmapping().then((response) => {
