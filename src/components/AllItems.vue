    ...
    <div v-if="this.activeUpload==true">
         <v-dialog
          ...
          v-model="activeUpload" >
           ...
           <v-card>
             <v-card-title style="background-color:#ccc;color:black">Upload Items</v-card-title>
        ...
        methods: {
           uploadItem(event){
            ...
            submitFile(){
                ...
                this.uploadItems(formData).then((response) => {
          ...
          this.addItem(reqJSON).then(response => {
            ...
            setInterval(this.close(), 3000);
                  ...
                  //GET API Calls
               getItems(){
                    this.getAllItemsList().then((response) => {
