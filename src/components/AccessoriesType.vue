<template>
    <div>
         ...
         <template v-slot:item="row" >
             <tr >
               ...
               <td style="text-align:left">
                 ...
                 <router-link :to="{ name: 'AccessoriesSearch', params: { fittingTypeCode: row.item.fittingTypeCode  } }">
        ...
        <template v-slot:top>
          ...
          >
            ...
            <v-spacer></v-spacer>
                <vue-excel-xlsx
                  :data="accessoriresList"
                  :columns="jsonfields"
                  :file-name="'Accessories Type'"
                  :file-type="'xlsx'"
                  :sheet-name="'sheetname'"
                  v-if="accessoriresList != ''"
                  >
                  <v-icon
                  large
                  color="green"
                  ...
                  <vue-excel-xlsx :data="json_data" :columns="json_data" :file-type="'xlsx'" :file-name="'Accessories Type'" :sheet-name="'sheetname'" v-if="accessoriresList == ''">                    
    ...
    <v-form ref="form" v-model="valid" lazy-validation @submit.prevent="saveItem"  > 
      ...
      <div v-if="this.dialog1==true">
        ...
        <div v-if="this.activeUpload==true">
         <v-dialog
          ...
          v-model="activeUpload" >
           ...
           <v-card>
             <v-card-title style="background-color:#2cb1fe;color:white;margin-top:-5px;">Upload Accessories Types</v-card-title>
        ...
        >
         <v-avatar class="img">
          <!-- <img src="../../assets/fire.jpg"  alt="logo"> -->
         </v-avatar>
    ...
    export default {
        ...
        data(){
            return {
              filename:'AllAccessoriesType',
              json_data: [{
            label: "Accessorires_Type_Code",
               field: "",
            },{
            label: "Accessorires_Type_Name",
               field: "",
          },
          {
            label: "Description",
         ...
         saveItemField(){
           ...
           uploadFile(event){
            ...
            submitFIle(){
                if(this.file ==''){
                   ...
                   formData.append('accessorires-types',this.file)
                   this.isUploadCard=true
                         this.uploadaccessoriresType(formData).then((response) => {
                ...
                // activate file upload Card
                  activeUploadCard(){
                    ...
                    // get delete item
                    deleteitem(item){
                      this.delItem=item.fittingTypeCode;
          ...
          this.addItem(reqJSON).then(response => {
            ...
            setInterval(this.close(), 3000);
                  ...
                  //GET API Calls
               getItems(){
                    this.getAllAccessories().then((response) => {       
               this.accessoriresList=response  
            }
            )},
